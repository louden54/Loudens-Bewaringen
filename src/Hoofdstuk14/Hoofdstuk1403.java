...
public class Hoofdstuk1403 extends Applet {
    ...
    public void init() {
        ...
        pad = Hoofdstuk1403.class.getResource("/Hoofdstuk14/resources/");
        AngryFace = getImage(pad, "evil-smiley-face.png");
        Smiley = getImage(pad, "Smiley.png");
        NormalFace = getImage(pad, "neutralface.png");
